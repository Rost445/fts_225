...
@section('content')
    <main class="pt-90">
                    ...
                    <div class="product-single__price">
                        <span class="current-price">
                            @if ($product->sale_price)
                                <s class="text-secondary">{{ number_format($product->regular_price, 2) }} &nbsp;₴</s>
                                {{ $product->sale_price }} &nbsp;₴
                            @else
                ...
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                        <a class="nav-link nav-link_underscore" id="tab-reviews-tab" data-bs-toggle="tab"
                            href="#tab-reviews" role="tab" aria-controls="tab-reviews" aria-selected="false">Відгуки
                            (2)</a>
                    </li>
                </ul>
        ...
        <section class="products-carousel container">
            <h2 class="h3 text-uppercase mb-4 pb-xl-2 mb-xl-4">Супутні <strong>Товари</strong></h2>
