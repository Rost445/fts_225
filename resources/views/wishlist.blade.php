...
@section('content')
    <main class="pt-90">
        ...
        <section class="shop-checkout container">
            <h2 class="page-title">Список бажань</h2>
                ...
                <div class="row">
                 <div class="col-md-12">
                    <div class="text-start">
                      ...
                      <p>Додайте товари до свого списку бажань, щоб зберегти їх для майбутніх покупок.</p>
                      <a href="{{ route('shop.index') }}" class="btn btn-primary">Повернутися до магазину</a>
                    </div>
                </div>
