    ...
    <main>
                        ...
                        <div class="overflow-hidden position-relative h-100">
                            ...
                            <div class="slideshow-text container position-absolute start-50 top-50 translate-middle">
                                ...
                                <h2 class="h1 fw-bold animate animate_fade animate_btt animate_delay-5">
                                    {{ $slide->subtitle }}</h2>
                                <a href="{{ $slide->link }}"
                                    class="btn-link btn-link_lg default-underline fw-medium animate animate_fade animate_btt animate_delay-7">Купити</a>
                            </div>
                        </div>
                    </div>
                @endforeach
        ...
        <div class="container mw-1620 bg-white border-radius-10">
            ...
            <section class="category-carousel container">
                <h2 class="section-title text-center mb-3 pb-xl-2 mb-xl-4">Вам може сподобатися</h2>
        ...
        <section class="hot-deals container">
            <h2 class="section-title text-center mb-3 pb-xl-3 mb-xl-4">Гарячі пропозиції</h2>
            <div class="row">
                <div
                    class="col-md-6 col-lg-4 col-xl-20per d-flex align-items-center flex-column justify-content-center py-4 align-items-md-start">
                    <h2>Актуальні Знижки</h2>
                    <h2 class="fw-bold"> </h2>
                    <a href="{{ route('shop.sale') }}" class="btn-link default-underline text-uppercase fw-medium mt-3">
                        Всі знижки
                    </a>
                </div>
                                            ...
                                            <div class="product-card__price d-flex">
                                                <span class="money price text-secondary">
                                                    @if ($sproduct->sale_price)
                                                        <s class="text-secondary">{{ number_format($sproduct->regular_price, 2) }}
                                                            &nbsp;₴</s> {{ $sproduct->sale_price }} &nbsp;₴
                                                    @else
                                                        <span
                                                            class="price-old text-secondary text-decoration-line-through ms-2">
                                                            ${{ number_format($sproduct->regular_price, 2) }}
                                                        </span>
                                                        {{ number_format($sproduct->regular_price, 2) }} &nbsp;₴
                                                    @endif
                                                </span>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="category-banner__item border-radius-10 mb-5">
                        <img loading="lazy" class="h-auto" src="" width="690" height="665" alt="" />
        ...
        <section class="products-grid container">
            <h2 class="section-title text-center mb-3 pb-xl-3 mb-xl-4">Рекомендовані продукти</h2>
            <div class="row">
                            ...
                            <div class="pc__info position-relative">
                                ...
                                <div class="product-card__price d-flex align-items-center">
                                    <span class="money price text-secondary"> @if ($fproduct->sale_price)
                                                        <s class="text-secondary">{{ number_format($fproduct->regular_price, 2) }}
                                                            &nbsp;₴</s> {{ $fproduct->sale_price }} &nbsp;₴
                                                    @else
                                                        <span
                                                            class="price-old text-secondary text-decoration-line-through ms-2">
                                                            ${{ number_format($fproduct->regular_price, 2) }}
                                                        </span>
                                                        {{ number_format($fproduct->regular_price, 2) }} &nbsp;₴
                                                    @endif</span>
                                </div>
...
{{-- 
            <div class="text-center mt-2">
                <a class="btn-link btn-link_lg default-underline text-uppercase fw-medium" href="#">Завантажити
                    більше</a>
            </div> --}}
        </section>
        </div>
