            ...
            <div class="row">
                ...
                <div class="col-lg-10">
                            ...
                            <table class="table table-striped table-bordered table-transaction">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <th>Статус</th>
                                        <td>
                                            @if ($transaction->status_ua == 'pending')
                                            ...
                                            @else
                                                <span
                                                    class="badge bg-success">{{ ucfirst($transaction->status_ua) }}</span>
                                            @endif
                                        </td>
                                    </tr>
                   ...
                   @if($order->status == 'ordered')
                    <div class="wg-box mt-5 border border-start-0 pt-4 border-danger">
                     <form action="{{ route('user.order.cancel', ['order_id' => $order->id]) }}" method="POST">
                            @csrf
                            @method('PUT')
                            <input type="hidden" name="order_id" value="{{ $order->id }}">
                            <div class="form-group  mb-3">
                              
                                <button type="submit" class="btn btn-danger cancel-order mt-3">Скасувати замовлення</button>
        ...
        $(function() {
            $('.cancel-order').on('click', function(e) {
                ...
                swal({
                     ...
                     title: "Cкасувати це замовлення?",
                     text: "Цю дію не можна буде відмінити!",
                    icon: "warning",
                    buttons: ["Не скасовувати", "Cкасувати замовлення"],
                    dangerMode: true,
