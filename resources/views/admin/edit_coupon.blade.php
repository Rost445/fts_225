        ...
        <div class="main-content-wrap">
            <div class="flex items-center flex-wrap justify-between gap20 mb-27">
                ...
                <ul class="breadcrumbs flex items-center flex-wrap justify-start gap10">
                    ...
                    <li>
                        <div class="text-tiny">Редагувати купон</div>
                    </li>
                </ul>
            </div>
            <div class="wg-box">
                ...
                <input type="hidden" name="id" value="{{ $coupon->id }}">
                    <fieldset class="name">
                        ...
                        <input class="flex-grow" type="text" placeholder="Код купона" name="code" tabindex="0"
                    ...
                    <fieldset class="category">
                        ...
                        <div class="select flex-grow">
                            <select class="" name="type">
                                ...
                                <option value="fixed" {{ $coupon->type == 'fixed' ? 'selected' : '' }}>Фіксована сума
                                </option>
                                <option value="percent" {{ $coupon->type == 'percent' ? 'selected' : '' }}>Відсоток</option>
                            </select>
                        </div>
                    </fieldset>
                    @error('type')
                    ...
                    <fieldset class="name">
                        ...
                        <input class="flex-grow" type="text" placeholder="Значення купона" name="value" tabindex="0"
                    ...
                    <fieldset class="name">
                        ...
                        <input class="flex-grow" type="text" placeholder="Сума замовлення" name="cart_value"
                    ...
                    <fieldset class="name">
                        ...
                        <input class="flex-grow" type="date" placeholder="Дата закінчення" name="expire_date"
